...
logger = logging.getLogger("xrstools.setup")
...
class BuildExt(build_ext):
    ...
    description = 'Build CI_test extensions'
...
class sdist_debian(sdist):
    ...
    * include .l man files
    ...
    def prune_file_list(self):
        ...
        self.filelist.exclude_pattern(pattern="*", prefix="CI_test/third_party/_local")
...
def get_project_configuration(dry_run):
    ...
    console_scripts = [
        'XRS_wizard = XRStools.WIZARD.XRS_wizard:main',
        'XRS_swissknife = XRStools.XRS_swissknife:main',
        'XRS_raman_extraction = XRStools.ramanWidget.MainWindow:main',
        'XRS_roiNmaSelection = XRStools.roiNmaSelectionGui.roiNmaSelectionWidget:main'
    ]
